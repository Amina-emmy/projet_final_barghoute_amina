                ...
                <div class="col-lg-8">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item">
                            ...
                            <p>Home <span>-</span> Single Product</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row s_product_inner justify-content-between">
                <div class="col-lg-7 col-xl-7">
                    <div class="product_slider_img">
                        <div id="vertical">
                            <div data-thumb={{ asset('storage/img/product/' . $product->image) }}>
                ...
                <div class="col-lg-5 col-xl-4">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                            ...
                            <li>
                                <a href="#">
                                    <span>Availibility</span>{{ $product->stock > 0 ? ': In Stock' : 'Out of Stock' }}</a>
                            </li>
                        </ul>
                        <p><span>Description</span> : <br> {{ $product->desc }}</p>
                        ...
                        <div class="col-lg-6">
                            <div class="comment_list">
                                ...
                                <div class="review_item reply">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src={{ asset('storage/img/product/single-product/review-2.png') }}
                                                alt="" />
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src={{ asset('storage/img/product/single-product/review-3.png') }}
                                                alt="" />
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
